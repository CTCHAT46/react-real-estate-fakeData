    ...
    <section>
      <div className='container mx-auto min-h-[800px] mb-14'>
        ...
        <div className='flex flex-col items-start gap-8 lg:flex-row'>
          ...
          <div className='flex-1 bg-white mb-8 border border-gray-300 rounded-lg px-6 py-8 w-full'>
            ...
            <form className='flex flex-col gap-y-4'>
              ...
              <div className='flex gap-x-2'>
                <button className='bg-violet-700 hover:bg-violet-800 text-white rounded p-4 text-sm w-full transition'>Send Message
                </button>
